...
<title><?php if($editTitle){ echo $editTitle.'｜'; } elseif(isset($title) && !$toppage) { echo $title.'｜';} ?>京都の感動エンターテイメント ギア-GEAR-</title>
...
<?php if( $toppage_pc ): ?>
<link rel="stylesheet" href="<?php echo THEME_CSS; ?>/pc_mega_menu.css">
<script src="<?php echo THEME_JS; ?>/pc_mega_menu.js"></script>
<?php else : ?>
...
<?php if( $toppage_pc ): ?>
<header class="pc_pageheader">
<div class="titleBox clearfix">
<div class="logo"><a href="/"><img src="<?php echo THEME_IMAGES; ?>/logo_gear.png" alt="ギア-GEAR-" ></a></div>
<h1 class="siteName">京都の感動エンターテイメント<br>ギア-GEAR-</h1>
<?php get_template_part( 'parts/pc_header_btnBox' ); // PC header ボタングループ ?>
</div>
<?php else : ?>
...
<!-- PCのgNaviここから -->
<?php get_template_part( 'parts/pc_header_gNavi' ); // PC gNavi ?>
<!-- PCのgNaviここまで -->
