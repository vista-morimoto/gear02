...
<p class="notes">※サイドエリアは、1階席後方端及び2階後方のお席となります。 舞台セット及び客席、映像機器の配置上、一部シーンによっては見えづらい席となります。また、ギアの日割、ファンクラブ割、リピーディスカウントチケットなどの割引対象にはなりませんので、予めご了承の上、チケットをお買い求めください。<br>
