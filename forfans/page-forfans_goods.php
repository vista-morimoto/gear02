<?php /*Template Name: FOR FANS - グッズ */ ?>
<?php 
global $description;

$description = '山田章博氏イメージイラストを使用したTシャツ、ポストカードをはじめとする、会場で購入できるオリジナルグッズのご紹介。京都で出逢える感動エンターテイメント『ギア-GEAR-』は、絶賛ロングラン公演中！';
...
<p class="overview">
山田章博氏デザインのキャラクターを使用したTシャツをはじめ、オリジナルグッズを販売中です。<br>
ぜひご来場の際にお買い求めください。
</p>
</div>
...
<img src="<?php echo THEME_URI; ?>/forfans/img/goods/img_line.jpg" alt="LINEスタンプ">
<div class="othersBox">
<h4><img src="<?php echo THEME_URI; ?>/forfans/img/goods/tit_line.png" alt="LINEスタンプ販売中！"></h4>
