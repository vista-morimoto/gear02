<?php /*Template Name: 英語 - プレス窓口 - 過去ニュース */ ?>
<?php 
global $editTitle;
global $lang;
global $breadcrumbs;
...
<li><span property="name">PAST NEWS</span><meta property="position" content="4"></li>
';
...
<li><a href="/press/past_news/<?php echo $lang; ?>">ALL</a></li>
<?php wp_get_archives2('post_type=past_news&type=monthly'); ?>
</ul>
</div>
...
<a href="<?php the_permalink(); ?><?php echo $lang; ?>">
<div class="tit">
